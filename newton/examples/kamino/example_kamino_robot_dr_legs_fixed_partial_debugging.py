...
def remove_bodies_from_builder(builder: newton.ModelBuilder, body_labels: Sequence[str]) -> None:
    ...
    original_joint_mimic_joint = list(builder.joint_mimic_joint)
    original_joint_mimic_coeffs = list(builder.joint_mimic_coeffs)
    ...
    new_joint_mimic_joint: list[int] = []
    new_joint_mimic_coeffs: list[Any] = []
    ...
    for joint_id in joints_to_keep:
        ...
        new_joint_mimic_joint.append(joint_remap.get(original_joint_mimic_joint[joint_id], -1))
        new_joint_mimic_coeffs.append(original_joint_mimic_coeffs[joint_id])
    ...
    builder.joint_mimic_joint = new_joint_mimic_joint
    builder.joint_mimic_coeffs = new_joint_mimic_coeffs
